    ...
    for (let slot = 0; slot < TOTAL_SLOTS; slot++) {
      ...
      rowCells.push(
        <div
          ...
          } border ${pickNumber === currentPickNumber && !isDraftCompleted ? "border-2 border-primary animate-pulse" : ""} overflow-hidden`}
        >
              ...
              <div className="relative w-full h-full flex items-center justify-center">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center">
                  ...
                  <span className="mt-1 text-xs font-medium truncate bg-background/80 backdrop-blur-sm px-2 py-0.5 rounded">
                    <span className="text-muted-foreground">({pick.league_teams.global_teams?.seed})</span>{" "}
...
export function DraftBoard({
  ...
  console.log("DraftBoard props:", { leagueMembers, draftPicks, currentPickNumber, maxTeams, isDraftCompleted })

  const board = useMemo(() => {
    console.log("Rendering draft board")
    return renderDraftBoard(leagueMembers, draftPicks, currentPickNumber, maxTeams, isDraftCompleted)
