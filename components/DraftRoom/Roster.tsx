    ...
    <div className="h-full flex flex-col">
      ...
      <ScrollArea className="flex-grow -mx-2 px-2">
        <div className="space-y-1.5 sm:space-y-2">
          ...
          {remainingPicks > 0 ? (
            <p className="text-xs sm:text-sm text-muted-foreground mt-2 px-2">Remaining picks: {remainingPicks}</p>
          ) : (
            <p className="text-xs sm:text-sm text-green-500 mt-2 px-2">All picks completed</p>
          )}
        </div>
      </ScrollArea>
    </div>
