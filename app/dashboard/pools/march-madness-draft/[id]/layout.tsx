...
// Redirect non-members to dashboard instead of showing locked message
if (!isLeagueMember && !isCommissioner) {
  ...
  console.log(
    ...
    draftStatus,
    "Raw drafts data:",
    leagueData.drafts.status
  );
  const isPaymentRequired =
    draftStatus === "completed" && leagueData.payment_status !== "paid";
    ...
    <ScrollToTopLayout>
      <LeagueProvider leagueId={params.id}>
        <div className="flex flex-col min-h-full">
          ...
          {/* Settings Button - Floating (Only for Commissioner) */}
          {isCommissioner && (
